...
cmsRun -e -j ${CHANNEL_DECAY}_step4.log  step3-NanoAOD-${CHANNEL_DECAY}_cfg.py
#cleaning
#rm -rfv step2-DR-${CHANNEL_DECAY}.root
...
cmsRun -e -j FrameworkJobReport.xml inputFiles=file:step3-MiniAOD-${CHANNEL_DECAY}.root outputFile=MC-${YEAR}-${CHANNEL_DECAY}.root
#cleaning

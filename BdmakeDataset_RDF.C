...
void BdmakeDataset_RDF(UInt_t iset=0)
{  
  bool usePV =false;
  ...
  TChain tree("treeS");
  tree.Add("ROOT_slim_Bdks0_2023MiniAOD.root/treeS");/////////////Changed
...
////////////////////////////J/Psi filters
  ...
  auto Jpsi_window = Form("massJ<%1.6f+0.150000 && massJ>%1.6f-0.150000",Jpsi_mass,Jpsi_mass);
...
////////////////////////////////////// B0d filters
  ...
  const vector<string> columns  = {"massB", "massJ","masslamb","mu1pt","mu2pt","mu1eta","mu2eta", "Jpsipt", "Bpt", "Bprob"};
  TString ofile = "Bd-rootuple_RDF.root";
